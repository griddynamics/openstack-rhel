...
Name:             openstack-%{prj}
Version:          2011.3
Release:          0.20110629.142.1%{?dist}
Summary:          OpenStack Image Registry and Delivery Service

Group:            Development/Languages
License:          ASL 2.0
URL:              http://%{prj}.openstack.org
Source0:          http://glance.openstack.org/tarballs/glance-%{version}~d2.tar.gz
...
%changelog
* Fri Jul 01 2011 Andrey Brindeyev <abrindeyev@griddynamics.com> - 2011.3-0.20110629.142.1
- Diablo-2 versioning
